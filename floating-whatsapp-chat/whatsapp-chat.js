        ...
        if(settings.selector != ''){
            ...
            if(element !=null){
                var chatBox = '<div class="ayoan_whatsapp_chatbox_container">' +
                    ...
                    '<img class="header-icon" src="floating-whatsapp-chat/assets/whatsapp.svg"> </div><div class="col col-2">' +
                    '<div class="header-title text-start">Iniciar conversación</div><div class="header-content">'+settings.headerMessage+
                    ...
                    '<img class="icon" src="floating-whatsapp-chat/assets/close.svg"></button></div></div>' +
                    '<div class="rs-openChatBtn widget-close-btn-row" >' +
                    '<button type="button" class="rs-openChatBtn widget-close-btn">' +
                    '<img class="icon" src="floating-whatsapp-chat/assets/whatsapp.svg" alt="Logo WhatsApp"></button></div></div>';
                ...
                for (var i = 0; i < goToWhatsapp.length; i++) {
                    goToWhatsapp[i].addEventListener("click", function(){
                        ...
                        message = "Hola! Me estoy comunicando a través del chat de WhatsApp de la página web alturashseq.com";
